...
const zh: Dict = {
  ...
  "channels.status.pending": "待验证",
  "channels.status.active": "可用",
  "channels.status.watching": "观察中",
  "channels.status.dead": "失效",
  ...
  "channels.sync.hint": "导出的 JSON 包含分组和所有备注/价格标注，导入时会合并到当前数据中。建议定期备份一次。",
...
const en: Dict = {
  ...
  "channels.summary.pending": "Pending",
  ...
  "channels.status.watching": "Watching",
  "channels.status.dead": "Dead",
  "channels.status.blocked": "Blocked",
  ...
  "channels.sync.hint": "Exported JSON includes groups and all notes/price tags. Import merges into current data. Recommended: back up periodically.",
