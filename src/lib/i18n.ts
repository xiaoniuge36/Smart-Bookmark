...
const zh: Dict = {
  ...
  "channels.detail.lastChecked": "最后复核",
  "channels.detail.missingSince": "失踪时间",
  "channels.detail.notChecked": "未复核",
  "channels.detail.open": "打开",
  "channels.detail.copy": "复制",
  "channels.detail.markChecked": "已复核",
  ...
  "channels.sync.title": "数据同步 / 备份",
  "channels.sync.subtitle": "Chrome 账号登录后分组和标注自动同步到其他设备",
  "channels.sync.export": "导出数据",
  "channels.sync.exportHtml": "导出 HTML",
  "channels.sync.import": "导入数据",
  "channels.sync.hint": "JSON 用于备份和导入合并；HTML 会生成一个带链接的静态页面，可直接发给别人打开。",
...
const en: Dict = {
  ...
  "channels.summary.highRisk": "High risk",
  ...
  "channels.detail.lastChecked": "Last checked",
  "channels.detail.missingSince": "Missing since",
  "channels.detail.notChecked": "Not checked",
  "channels.detail.open": "Open",
  "channels.detail.copy": "Copy",
  "channels.detail.markChecked": "Mark checked",
  ...
  "channels.sync.title": "Sync / Backup",
  "channels.sync.subtitle": "Groups and annotations auto-sync across devices via your Chrome account",
  "channels.sync.export": "Export data",
  "channels.sync.exportHtml": "Export HTML",
  "channels.sync.import": "Import data",
  "channels.sync.hint": "JSON is for backup/import merge; HTML creates a linked static page you can share directly.",
